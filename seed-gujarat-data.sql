...
INSERT INTO procurement_documents (id, po_number, quotation_id, po_status) VALUES
  ('00000006-0000-4000-8000-000000000001', 61, '00000004-0000-4000-8000-000000000001', 'Pending Payment'),
  ('00000006-0000-4000-8000-000000000002', 74, '00000004-0000-4000-8000-000000000004', 'Pending Payment'),
  ('00000006-0000-4000-8000-000000000003', 58, '00000004-0000-4000-8000-000000000007', 'Paid'),
  ('00000006-0000-4000-8000-000000000004', 71, '00000004-0000-4000-8000-000000000008', 'Paid')
ON CONFLICT (id) DO NOTHING;
