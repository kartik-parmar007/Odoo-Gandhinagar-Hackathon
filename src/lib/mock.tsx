...
const seedVendors: Vendor[] = [
  ...
  {
    id: "v6",
    name: "Akshar Infotech Solutions",
    category: "IT Hardware",
    gst: "24AAKCS9321F1ZP",
    contact: "+91 99099 45678",
    rating: 4.7,
    status: "Active",
  },
  {
    id: "v7",
    name: "Surat Textile Traders Pvt Ltd",
    category: "Textile & Fabric",
    gst: "24BTRST4567G2ZQ",
    contact: "+91 97234 78901",
    rating: 4.2,
    status: "Active",
  },
  {
    id: "v8",
    name: "Vadodara Industrial Supplies",
    category: "Industrial Equipment",
    gst: "24CVDIS8821H3ZR",
    contact: "+91 98792 33445",
    rating: 3.8,
    status: "Active",
  },
  {
    ...
    gst: "24DRJPE1234J4ZS",
    contact: "+91 96380 55667",
    rating: 4.4,
    status: "Pending",
  },
  {
    id: "v10",
    name: "Gandhinagar Office Essentials",
    category: "Stationery",
    gst: "24EGNOE7654K5ZT",
    contact: "+91 93745 12300",
    rating: 4.0,
    status: "Active",
  },
];
...
const seedRFQs: RFQ[] = [
  ...
  {
    id: "r3",
    title: "Desktop Computers for Ahmedabad Branch",
    category: "IT Hardware",
    deadline: "2026-07-10",
    items: [
  ...
  {
    id: "r4",
    title: "Uniform Fabric for Surat Factory Staff",
    category: "Textile & Fabric",
    deadline: "2026-07-05",
    items: [
  ...
  {
    id: "r5",
    title: "Industrial Compressors for Vadodara Plant",
    category: "Industrial Equipment",
    deadline: "2026-07-20",
    items: [
      { name: "Rotary Screw Compressor 10HP", qty: 3, description: "Oil-lubricated, 145 PSI max" },
      {
        name: "Air Dryer Unit",
        qty: 3,
        description: "Refrigerated type, compatible with above compressor",
      },
    ],
  ...
  {
    id: "r6",
    title: "CNC Machined Spare Parts — Rajkot Unit",
    category: "Mechanical Parts",
    deadline: "2026-06-30",
    items: [
  ...
  {
    id: "r7",
    title: "Stationery & Office Supplies — Gandhinagar HQ",
    category: "Stationery",
    deadline: "2026-06-25",
    items: [
      {
        ...
        qty: 200,
        description: "75 GSM, JK Copier or equivalent",
      },
...
const seedQuotations: Quotation[] = [
  {
    ...
    vendorId: "v1",
    lines: [
      { item: "Ergonomic Chair", qty: 25, unitPrice: 3600 },
      { item: "Standing Desk", qty: 10, unitPrice: 9200 },
    ],
    deliveryDays: 14,
  ...
  },
  {
    ...
    vendorId: "v5",
    lines: [
      { item: "Ergonomic Chair", qty: 25, unitPrice: 3850 },
      { item: "Standing Desk", qty: 10, unitPrice: 8900 },
    ],
    deliveryDays: 18,
  ...
  },
  {
    ...
    rfqId: "r2",
    vendorId: "v2",
    lines: [{ item: "Laptop 16GB", qty: 40, unitPrice: 68000 }],
    deliveryDays: 21,
  ...
  // Gujarat-based quotations
  {
    ...
    vendorId: "v6",
    lines: [
      { item: "Desktop PC Core i5", qty: 20, unitPrice: 42500 },
      { item: "24-inch Monitor", qty: 20, unitPrice: 11200 },
    ],
    deliveryDays: 10,
    notes: "Includes 1-year onsite warranty",
  ...
  },
  {
    ...
    vendorId: "v7",
    lines: [
      { item: "Cotton Drill Fabric", qty: 500, unitPrice: 185 },
      { item: "Reflective Safety Vest", qty: 150, unitPrice: 420 },
    ],
    deliveryDays: 7,
    notes: "Fabric sourced from GPCL-approved mill, Surat",
    submittedAt: "2026-06-05",
    status: "Submitted",
  },
  {
    ...
    vendorId: "v8",
    lines: [
      { item: "Rotary Screw Compressor 10HP", qty: 3, unitPrice: 125000 },
      { item: "Air Dryer Unit", qty: 3, unitPrice: 38000 },
    ],
    deliveryDays: 21,
    notes: "Atlas Copco authorised dealer, Vadodara",
  ...
  },
  {
    ...
    vendorId: "v9",
    lines: [
      { item: "Mild Steel Flange (DN50)", qty: 80, unitPrice: 680 },
      { item: "Stainless Hex Bolt M12", qty: 500, unitPrice: 28 },
    ],
    deliveryDays: 5,
    notes: "Material test certificates included",
  ...
  },
  {
    ...
    vendorId: "v10",
    lines: [
      { item: "A4 Copier Paper (500 sheets)", qty: 200, unitPrice: 320 },
      { item: "Ball Pen Box (10 pcs)", qty: 100, unitPrice: 95 },
      { item: "File Folder Plastic", qty: 150, unitPrice: 25 },
    ],
    deliveryDays: 3,
    notes: "GST invoice provided; delivery to Sector 11, Gandhinagar",
...
const seedApprovals: Approval[] = [
  ...
  // Gujarat-based approvals
  {
    ...
    quotationId: "q4",
    state: "Approved",
    approver: "Dhruv Patel",
    remarks: "Best price-to-spec ratio; proceed with PO",
  ...
  },
  {
    ...
    quotationId: "q7",
    state: "Approved",
    approver: "Meenaben Desai",
    remarks: "Delivery timeline acceptable; material certs on file",
  ...
  },
  {
    ...
    quotationId: "q5",
    state: "Under Review",
    approver: "Jignesh Solanki",
    remarks: "Awaiting fabric swatch sample verification",
    updatedAt: "2026-06-06",
  },
  { id: "a6", quotationId: "q6", state: "Pending", updatedAt: "2026-06-06" },
  {
    ...
    quotationId: "q8",
    state: "Approved",
    approver: "Hiral Bhatt",
    remarks: "Routine stationery replenishment; approved as per SOP",
...
const seedLogs: ActivityLog[] = [
  {
    id: "l1",
    type: "quotation",
    message: "Quotation submitted — Infra Supplies Pvt Ltd selected for Office Furniture Q2",
    timestamp: "2026-06-02T16:15:00Z",
  },
  {
    id: "l2",
    type: "approval",
    message: "Approval pending — PO-2026 awaiting L2 approval by Priya Shah",
  ...
  },
  {
    id: "l4",
    type: "vendor",
    message: "Vendor added — FastLog Logistics registered and pending verification",
  ...
  // Gujarat-based activity logs
  {
    ...
    type: "vendor",
    message:
      "Vendor registered — Akshar Infotech Solutions, Ahmedabad (IT Hardware) verified and activated",
    timestamp: "2026-06-01T10:30:00Z",
  },
  {
    id: "l6",
    type: "rfq",
    message: "RFQ published — Desktop Computers for Ahmedabad Branch sent to 2 vendors",
  ...
  },
  {
    ...
    type: "approval",
    message:
      "Quotation approved — Akshar Infotech Solutions selected for Ahmedabad Desktop procurement; PO-2026-0074 raised",
  ...
  },
  {
    ...
    type: "po",
    message:
      "PO paid — PO-2026-0058 settled; Rajkot Precision Engineering delivered CNC parts to Rajkot Unit",
  ...
  },
  {
    ...
    type: "rfq",
    message:
      "RFQ published — Stationery & Office Supplies for Gandhinagar HQ assigned to Gandhinagar Office Essentials",
  ...
  },
  {
    ...
    type: "approval",
    message:
      "Approval under review — Surat Textile Traders fabric quotation pending swatch verification by Jignesh Solanki",
...
const seedProfiles: Profile[] = [
  ...
  // Gujarat-based profiles
  {
    ...
    email: "dhruv.patel@vendorbridge.app",
    phone: "+91 98250 67891",
    role: "Manager",
    country: "India",
    notes: "Operations Manager — Ahmedabad Regional Office",
    avatar:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=256&h=256&fit=crop",
  },
  {
    id: "p3",
    firstName: "Meenaben Desai",
    email: "meena.desai@vendorbridge.app",
    phone: "+91 97250 34567",
    role: "Admin",
    country: "India",
    notes: "Senior Admin — Vadodara Plant",
    avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=256&h=256&fit=crop",
  },
  {
    id: "p4",
    firstName: "Jignesh Solanki",
    email: "jignesh.solanki@vendorbridge.app",
    phone: "+91 96670 11223",
    role: "Procurement Officer",
    country: "India",
    notes: "Procurement Officer — Surat Textile Division",
    avatar:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=256&h=256&fit=crop",
  },
  {
    id: "p5",
    firstName: "Hiral Bhatt",
    email: "hiral.bhatt@vendorbridge.app",
    phone: "+91 93745 99001",
    role: "Procurement Officer",
    country: "India",
    notes: "Procurement Officer — Gandhinagar HQ",
    avatar:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=256&h=256&fit=crop",
  },
  {
    id: "p6",
    firstName: "Nikunj Mehta",
    email: "nikunj.mehta@vendorbridge.app",
    phone: "+91 99797 55432",
    role: "Vendor",
    country: "India",
    notes: "Vendor Representative — Rajkot Precision Engineering",
    avatar:
...
export function MockProvider({ children }: { children: ReactNode }) {
  ...
  const refreshData = async () => {
    ...
    try {
      ...
      // Fetch Quotations
      const { data: dbQuotations, error: errQuotations } = await supabase
        .from("quotations")
        .select("*");
      if (errQuotations) throw errQuotations;

      // Fetch Approvals
      const { data: dbApprovals, error: errApprovals } = await supabase
        .from("approvals")
        .select("*");
      if (errApprovals) throw errApprovals;

      // Fetch Procurement Documents
      const { data: dbDocs, error: errDocs } = await supabase
